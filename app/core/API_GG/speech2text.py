...
# from new_model import Get_feature
...
from core.API_GG.constants import (
    LANGUAGE_CODES, GOOGLE_SPEECH_API_KEY, GOOGLE_SPEECH_API_URL,
)
from core.API_GG.formatters import FORMATTERS

DEFAULT_SUBTITLE_FORMAT = 'srt'
DEFAULT_CONCURRENCY = 1
DEFAULT_SRC_LANGUAGE = 'vi'
DEFAULT_DST_LANGUAGE = 'vi'
DEFAULT_OUTPUT = "data/Data_BoYte.srt"
# SOURCE_PATH = "data/ChatVan_Update.mp4"
...
def find_speech_regions(filename, frame_width=4096, min_region_size=0.5, max_region_size=10): # pylint: disable=too-many-locals
    """
...
def generate_subtitles( # pylint: disable=too-many-locals,too-many-arguments
    ...
    # speaker_Recog = SR(source_path=audio_filename)
    transcripts = []
    if regions:
        try:
            ...
            for i, transcript in enumerate(pool.imap(recognizer, extracted_regions)):
                ...
                pbar.update(i)
            print("transcripts from google API: {}".format(transcripts))
            pbar.finish()
...
if __name__ == '__main__':
    # sys.exit(main())
    main('File/destination-423142556.wav')